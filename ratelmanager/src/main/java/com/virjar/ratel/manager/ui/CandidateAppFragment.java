        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    RatelRepkger.mainShell(getActivity(), workDir.getAbsolutePath(), new String[]{"-s", "-d", "-w", workDir.getAbsolutePath(), "-e", "rebuildDex", "-o", outFile.getAbsolutePath(), originApkFile.getAbsolutePath()}, new RatelRepkger.LogCallback() {
                        @Override
